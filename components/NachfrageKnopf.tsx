...
// ---------------------------------------------------------------------------
// Löst die einmalige Nachfrage an die übernommenen Anmeldungen aus.
//
// Mit Rückfrage davor, wie beim Beitragsversand: Es geht an Menschen, die
// zuletzt bei alfima von dir gehört haben, und es lässt sich nicht
// zurücknehmen.
// ---------------------------------------------------------------------------

export default function NachfrageKnopf({ anzahl }: { anzahl: number }) {
    ...
    return (
      <div className="bg-white rounded-[14px] border border-line p-4">
        <p className="text-[14px] leading-relaxed mb-4">
          Die Nachfrage geht an <strong>{anzahl}</strong>{" "}
  ...
  return (
    <div>
      ...
      >
        {stand === "laeuft" ? "Wird verschickt …" : "Jetzt nachfragen"}
      </button>
      {stand === "fehler" && (
