      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mb-10 rounded-[16px] border border-line bg-white p-6">
          ...
          <ul className="grid gap-2">
            ...
            <Punkt
              ok={!!(process.env.INSTAGRAM_APP_GEHEIMNIS || process.env.META_APP_GEHEIMNIS)}
              text={`Geheimcodes: Instagram ${process.env.INSTAGRAM_APP_GEHEIMNIS ? "gesetzt" : "fehlt"}, App ${process.env.META_APP_GEHEIMNIS ? "gesetzt" : "fehlt"}. Ohne passenden Code wird jede Meldung von Meta abgelehnt.`}
            />
